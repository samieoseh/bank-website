...
export default function AreaChart() {
  const [options] = useState<ApexOptions>({
    ...
    grid: {
      ...
      borderColor: "#e0e0e0", // Light color for horizontal lines
      strokeDashArray: 4, // Optional: make grid lines dashed
      position: "back", // Position grid lines behind chart
    },
    fill: {
      type: "gradient",
      gradient: {
    ...
    title: {
      ...
      align: "right", // Align the title to the right
      style: {
